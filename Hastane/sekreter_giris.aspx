<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="sekreter_giris.aspx.cs" Inherits="IleriNet_Final2.sekreter_giris" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            <asp:Label ID="Label1" runat="server" Text="Sekreter Girişi" style="z-index: 100; left: 165px; position: absolute; top: 297px" Font-Bold="False" Font-Names="Helvetica" Font-Size="24pt" ForeColor="Red"></asp:Label>
