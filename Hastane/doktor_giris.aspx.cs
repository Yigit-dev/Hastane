...
{
    public partial class doktor_giris : System.Web.UI.Page
    {
        ...
        {
            /***********************DOKTOR GİRİŞ YAP BUTONU*********************************/
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM tbl_doktor_kayit WHERE tc='" + txtKimlik.Text + "' and sifre='" + txtSifre.Text + "'", con);
            ...
            if (dr.Read())
            {
                ...
                Session["doktor_klinik"] = ad;
                Session["welcome"] = adsoyad.ToString();
                Response.Redirect("doktor_anasayfa.aspx");
            }
            else
            {
