...
{
    public partial class doktor_kayitol : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("doktor_kayitol.aspx");

        }

        protected void canbtn_Click(object sender, EventArgs e)
        {
            Response.Redirect("doktor_giris.aspx");
        }
