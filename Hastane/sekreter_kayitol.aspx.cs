...
{
    public partial class sekreter_kayitol : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("sekreter_kayitol.aspx");

        }

        protected void canbtn_Click(object sender, EventArgs e)
        {
            Response.Redirect("sekreter_giris.aspx");
        }
