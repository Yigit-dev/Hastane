<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="hasta_giris.aspx.cs" Inherits="IleriNet_Final2.hasta_giris" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:Label ID="Label1" runat="server" Text="Hasta Girişi" style="z-index: 100; left: 165px; position: absolute; top: 297px" Font-Bold="False" Font-Names="Helvetica" Font-Size="24pt" ForeColor="Red"></asp:Label>
        <table style="z-index: 100; left: 164px; position: absolute; top: 369px; font-family: 'Helvetica';">
            <tr>
                ...
                <td style="width: 100px; height: 21px">
                    <asp:TextBox ID="txtKimlik" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 21px">
                    <asp:Button ID="Button1" runat="server" Text="Giriş" Width="65px" OnClick="Button1_Click" /></td>
            </tr>
        </table>
