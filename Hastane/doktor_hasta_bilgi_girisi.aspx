<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="doktor_hasta_bilgi_girisi.aspx.cs" Inherits="IleriNet_Final2.doktor_hasta_bilgi_girisi" %>
...
<table style="color: #fff; left: 900px; font-family: 'Helvetica';" class="auto-style24">
<tr>
    <td><asp:Button ID="btnEkle" runat="server" Text="Kayıt Et" Width="187px" OnClick="btnEkle_Click" /></td>
</tr>
</table>
</asp:Content>
