...
{
    public partial class admin_doktor_profilleri : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlDataAdapter hastaProfil = new SqlDataAdapter("SELECT * FROM tbl_doktor_kayit", con);
        ...
        public void GirisKontrolleri()
        {
            ...
            RangeValidator1.Text = "Doğum Tarihiniz 1940 ile 2020 arasında olmalı";
            ...
            RangeValidator2.Text = "Son Geçerliliğiniz 2021 ile 2040 arasında olmalı";
