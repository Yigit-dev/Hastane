<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="sekreter_kayitol.aspx.cs" Inherits="IleriNet_Final2.sekreter_kayitol" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="Label1" runat="server" Text=" Kayıt ol" style="z-index: 100; left: 175px; position: absolute; top: 174px; height: 39px; width: 222px;" Font-Names="Helvetica" Font-Size="25pt" ForeColor="Red"></asp:Label>
    <asp:Label ID="Label2" runat="server" Text=" Kayıt ol" style="z-index: 100; left: 175px; position: absolute; top: 174px; height: 39px; width: 222px;" Font-Names="Helvetica" Font-Size="25pt" ForeColor="Red"></asp:Label>
      ...
      <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="RangeValidator"></asp:RangeValidator>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
            ...
            <tr><td style="height: 26px; width: 176px;">Cinsiyet</td><td style="height: 26px">
                <asp:RadioButton ID="rdbKadin" runat="server" Text="Kadın" OnCheckedChanged="rdbKadin_CheckedChanged" />
                <asp:RadioButton ID="rdbErkek" runat="server" Text="Erkek" OnCheckedChanged="rdbErkek_CheckedChanged" />
        </td></tr>
    ...
    <table style="z-index: 101; left: 899px; position: absolute; top: 620px; font-weight: bold; color: #ffffff; font-family: 'Lucida Console';">
    <tr><td style="width: 88px">
        <asp:Button ID="subbtn" runat="server" Text="Kayıt Ol" Width="94px" OnClick="subbtn_Click" /></td>
        <td style="width: 93px">
        <asp:Button ID="Resbtn" runat="server" Text="Sıfırla" Width="94px" OnClick="Resbtn_Click" /></td>
        <td style="width: 93px">
        <asp:Button ID="canbtn" runat="server" Text="Giriş Yap" Width="94px" OnClick="canbtn_Click" /></td></tr>
    </table>
    <table style="z-index: 101; left: 899px; position: absolute; top: 720px; font-weight: bold; color: #ffffff; font-family: 'Lucida Console';">
    <tr><td style="width: 88px">
